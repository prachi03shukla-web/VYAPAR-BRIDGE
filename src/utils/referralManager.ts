...
import { safeSaveUser, safeSetLocalStorage } from './safeStorage';
    ...
    try {
      ...
      if (cachedUsersStr) {
        ...
        if (Array.isArray(usersList)) {
          ...
          safeSetLocalStorage(LOCAL_USERS_CACHE_KEY, updatedList);
        }
      }
    ...
    try {
      ...
      if (cachedUsersStr) {
        ...
        if (Array.isArray(usersList)) {
          ...
          safeSetLocalStorage(LOCAL_USERS_CACHE_KEY, newList);
        }
      }
